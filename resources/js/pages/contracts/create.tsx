...
import { index as contractsIndex, store as contractsStore } from '@/actions/App/Http/Controllers/ContractController';
...
export default function ContractsCreate({ employees, selectedEmployeeId }: ContractsCreateProps) {
    const form = useForm({
        employee_id: selectedEmployeeId != null ? String(selectedEmployeeId) : '',
        type: 'cdi',
        start_date: '',
        end_date: '',
        base_salary: '',
        ...
        <>
            ...
            <section className="space-y-5">
                <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 sm:text-3xl">Nouveau contrat</h1>
                        <p className="mt-1 text-sm text-slate-600">Choisissez l&apos;employe, le type de contrat et joignez le fichier signe.</p>
                    </div>
                    <Link
                    ...
                    <form onSubmit={submit} className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2 md:col-span-2">
                            <label htmlFor="document" className="block text-sm font-medium text-slate-700">
                                Fichier du contrat (PDF, Word ou image)
                            </label>
                            <input
                                id="document"
                                type="file"
...
ContractsCreate.layout = (page: ReactNode) => <AppLayout>{page}</AppLayout>;
